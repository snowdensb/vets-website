...
import * as mockUser from '../fixtures/test-user.json';
...
describe('VRE Chapter 31', () => {
  ...
  describe('Introduction', () => {
    ...
    it('Should update page after login', () => {
      const myMockUser = {
        data: mockUser.data,
        meta: mockUser.meta,
      };
      ...
      cy.login(myMockUser);
      cy.reload();
      cy.contains(/start.+without.signing.in/i).should('not.exist');
      cy.get('button.schemaform-start-button')
        .eq(0)
        .click();
